...
- Every `brain_remember` note must include a source reference — a ticket key, Slack channel + date, doc name, or file path. Notes without breadcrumbs are dead ends.
